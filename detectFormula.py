...
def run():
    weights = ROOT / 'best0804Eqv.pt'  # model path or triton URL
    source = ROOT / 'photos'  # file/dir/URL/glob/screen/0(webcam)
    ...
    project = ROOT / 'detectFormula'  # save results to project/name
    print(project)
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        print(names[c])
                        cv2.imwrite("/content/drive/MyDrive/yolov5/crop/%i.png" % i,
                                    cropped_img)  ###-----put the output folder path here---####
